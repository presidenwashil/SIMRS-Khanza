 ...
 */
public class FormMobileJKN extends javax.swing.JFrame {

    private Connection koneksi = koneksiDB.condb();
    private sekuel Sequel = new sekuel();
    private String requestJson, URL = "", utc = "", link = "", datajam = "", datataskid = "",
        nol_jam = "", nol_menit = "", nol_detik = "", jam = "", menit = "", detik = "", hari = "", noresep = "", jenisracikan = "",
    ...
    /**
     * Creates new form FormMobileJKN
     */
    public FormMobileJKN() {
        initComponents();
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormMobileJKN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormMobileJKN().setVisible(true);
            }
        });
    }
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (detik.equals("01") && ((nilai_menit % 10) == 0)) {
                    ...
                    try {
                        ...
                        TeksArea.append("\nMenjalankan WS batal antrian Mobile JKN Pasien BPJS\n");
                        ps = koneksi.prepareStatement(
